...
// Validate ../../../app/api/allpay/create-payment/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/allpay/create-payment">> = Specific
  const handler = {} as typeof import("../../../app/api/allpay/create-payment/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../../app/api/allpay/webhook/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/allpay/webhook">> = Specific
  const handler = {} as typeof import("../../../app/api/allpay/webhook/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
